const paciente = ({paciente, setPaciente, eliminarPaciente}) => {
  ...
  const {nombre, propietario, email, fecha, sintomas, id} = paciente //De "paciente extraera por medio de un destructuring los valores"
  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
        ...
        <div className="flex justify-between mt-10">
          <button type="button" className="py-2 px-10 bg-indigo-600 hover:bg-indigo-700 text-white font-bold uppercase rounded-lg" onClick={() => setPaciente(paciente)}>Editar</button> {/*Al hacerle click el setPaciente tomara los datos del Paciente que se quiere editar, esto llega hasta el componente de "App"*/}
